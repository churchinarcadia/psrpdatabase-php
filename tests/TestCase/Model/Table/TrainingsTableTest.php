...
class TrainingsTableTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->TrainingsTable = $this->getTableLocator()->get('Trainings', $config);
    }
     ...
     *
     * @return void
     * @uses \App\Model\Table\TrainingsTable::buildRules()
     */
